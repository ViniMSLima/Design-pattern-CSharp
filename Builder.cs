...
public static class StateBuilderExtensions
{
    public static StateBuilder AddMovingState(
        this StateBuilder builder, float targetX, float targetY
    )
    {
        builder.AddState(new MovingState {XTarget = targetX, YTarget = targetY});
        return builder;
    }

    public static StateBuilder AddRotateState(
        this StateBuilder builder, float targetAngle
    )
    {
        builder.AddState(new RotateState {AngleTarget = targetAngle});
        return builder;
    }
}